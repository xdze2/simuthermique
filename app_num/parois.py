...
R_thermique_brique = resistance_thermiqe(.40, ThermalConductivity.BriqueTerreCuite)
print(f"{R_thermique_brique=:.1f}")

R_thermique_isolant = resistance_thermiqe(.10, ThermalConductivity.LaineVerre)
